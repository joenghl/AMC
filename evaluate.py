...
from algorithms.mean_sac import MeanSAC
...
def run(config):
    ...
    attention_sac = MeanSAC.init_from_save(model_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--env_id", default="rendezvous_v1",help="Name of environment")
    parser.add_argument("--model_name",default="n20",
                        help="Name of model")
    parser.add_argument("--run_num", default=2, type=int)
    parser.add_argument("--save_gifs", action="store_true",
                        help="Saves gif of each episode into model directory")
    parser.add_argument("--incremental", default=19903, type=int,
